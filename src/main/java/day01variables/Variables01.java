    ...
    /*
     ...
     Note: Numeric Data Types: byte < short < int < long < float < double
      ...
      String: Isim, adres, kimlik numarasi gibi bir veya birden fazla karakter iceren degerlerde kullanilir.
              ...
              1-) Non-primitive'lerde değerin yanında method vardır. Primitiv'lerde method yoktur.
              2-) Primitiv'ler Java tarafında oluşturulmuştur. Toplam 8 tanedir. Biz oluşturamayız.
                  Non-primitiv'ler Java tarafından oluşturulmuştur ancak biz de oluşturabilirz. Sayıları
                  sayılamayacak kadar çoktur çünkü her developer oluşturabilir.
              3-) Primitivler'in isimleri küçük harfle başlar. Non-primitive'ler büyük harfle başlar.
              4-) Primitivler memory de farklı büyüklükte yer kaplar. Non primitivler'in büyüklüğü sabittir.
